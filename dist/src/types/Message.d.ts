type WepinCommand = 'ready_to_widget' | 'initialized_widget' | 'set_accounts' | 'close_wepin_widget' | 'provider_request' | 'dequeue_request' | 'set_token' | 'set_user_info' | 'wepin_logout' | 'request_enable' | 'sign_transaction' | 'send_transaction' | 'sign_typed_data' | 'sign' | 'wallet_switchEthereumChain' | 'signup_email' | 'login_email' | 'register_wepin' | 'get_balance';
